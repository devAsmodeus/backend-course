...
class RoomsFacilitiesRepository(BaseRepository):
    ...
    async def set_room_facilities(
        ...
        result = await self.db_session.execute(get_current_facilities_ids_query)
        ...
        if ids_to_delete:
            ...
            await self.db_session.execute(delete_m2m_facilities_stmt)
        ...
        if ids_to_insert:
            ...
            await self.db_session.execute(insert_m2m_facilities_stmt)
